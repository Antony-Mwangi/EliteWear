        ...
        <div className="w-full max-w-md rounded-2xl border border-zinc-200 bg-white p-6 sm:p-8 shadow-sm">
          ...
          <div className="mb-8 flex flex-col items-center text-center">
            ...
            <p className="mt-1.5 text-xs text-zinc-500">
              Join us to curate your lifestyle collections and track fresh orders.
            </p>
          </div>
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            {/* Terms and Legal Agreement Framework */}
            <div className="flex items-start gap-2.5 pt-1">
              ...
              <label
                htmlFor="terms"
                className="text-xs leading-normal text-zinc-500"
              >
                I agree to the{" "}
                <Link
                  href="/terms"
                  className="font-medium text-zinc-950 underline underline-offset-2 hover:opacity-80 transition-opacity"
                >
                  Terms of Service
                </Link>{" "}
                and{" "}
